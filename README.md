...
| config.custom_wellknown_endpoint       | no      |                   | An URL which should expose the wellknown_endpoint of the issuer. If you don't provide this URL, the default URL will be used (obtained from jwt token issuer field + well_known template).                                                                                                                                                                                               |
