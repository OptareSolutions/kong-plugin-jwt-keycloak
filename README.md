...
| config.public_keys_url                 | no      |                   | An URL which should expose the public_keys of the issuer to check the validity of the JWT token. If you don't provide this URL, the default URL will be used (obtained from jwt token issuer field + well_known template)                                                                                                                                                                |
